...
function changeImg1() {
    quicImg1.addEventListener("click",
        mainImg1.setAttribute("src",
            `/Indoor Plantation/assets/products img/product1newclose.jpg`
        )
    )
}
function changeImg2() {
    quicImg2.addEventListener("click",
        mainImg1.setAttribute("src", `
            /Indoor Plantation/assets/products img/product1 new.jpg`)
    )
}
function changeImg3() {
    quicImg3.addEventListener("click",
        mainImg1.setAttribute("src", `
            /Indoor Plantation/assets/products img/product1front.jpg`)
    )
}
...
function changeImg4() {
    quicImg4.addEventListener("click",
        mainImg2.setAttribute("src",
            `/Indoor Plantation/assets/products img/product2 close.jpg`
        )
    )
}
function changeImg5() {
    quicImg5.addEventListener("click",
        mainImg2.setAttribute("src", `
            /Indoor Plantation/assets/products img/product2 new.jpg`)
    )
}
function changeImg6() {
...
function changeImg7() {
    quicImg7.addEventListener("click",
        mainImg3.setAttribute("src",
            `/Indoor Plantation/assets/products img/product3 close.jpg`
        )
    )
}
function changeImg8() {
    quicImg8.addEventListener("click",
        mainImg3.setAttribute("src", `
            /Indoor Plantation/assets/products img/product3 angle.jpg`)
    )
}
function changeImg9() {
    quicImg9.addEventListener("click",
        mainImg3.setAttribute("src", `
        /Indoor Plantation/assets/products img/product2.jpg`)
    )
}
...
function changeImg10() {
    quicImg10.addEventListener("click",
        mainImg4.setAttribute("src",
            `/Indoor Plantation/assets/products img/product4 close.jpg`
        )
    )
}
function changeImg11() {
    quicImg11.addEventListener("click",
        mainImg4.setAttribute("src", `
            /Indoor Plantation/assets/products img/product4 close2.jpg`)
    )
}
function changeImg12() {
    quicImg12.addEventListener("click",
        mainImg4.setAttribute("src", `
        /Indoor Plantation/assets/products img/product 4.jpg`)
    )
}
...
function changeImg13() {
    quicImg13.addEventListener("click",
        mainImg5.setAttribute("src",
            `/Indoor Plantation/assets/products img/product5close.jpg`
        )
    )
}
function changeImg14() {
    quicImg14.addEventListener("click",
        mainImg5.setAttribute("src", `
            /Indoor Plantation/assets/products img/product5 close 2.jpg`)
    )
}
function changeImg15() {
    quicImg15.addEventListener("click",
        mainImg5.setAttribute("src", `
       /Indoor Plantation/assets/products img//product 5.jpg`)
    )
}
...
function changeImg16() {
    quicImg16.addEventListener("click",
        mainImg6.setAttribute("src",
            `/Indoor Plantation/assets/products img/product 6 close2.jpg`
        )
    )
}
function changeImg17() {
    quicImg17.addEventListener("click",
        mainImg6.setAttribute("src", `
           /Indoor Plantation/assets/products img/product6 close.jpg`)
    )
}
function changeImg18() {
    quicImg18.addEventListener("click",
        mainImg6.setAttribute("src", `
       /Indoor Plantation/assets/products img/product 6.jpg`)
    )
}
...
function changeImg19() {
    quicImg19.addEventListener("click",
        mainImg7.setAttribute("src",
            `/Indoor Plantation/assets/products img/product7 close2.jpg`
        )
    )
}
function changeImg20() {
    quicImg20.addEventListener("click",
        mainImg7.setAttribute("src", `
          /Indoor Plantation/assets/products img/product 7 close.jpg`)
    )
}
function changeImg21() {
    quicImg21.addEventListener("click",
        mainImg7.setAttribute("src", `
     /Indoor Plantation/assets/products img/product7.jpg`)
    )
}
...
function changeImg22() {
    quicImg22.addEventListener("click",
        mainImg8.setAttribute("src",
            `/Indoor Plantation/assets/products img/product8close.jpg`
        )
    )
}
function changeImg23() {
    quicImg23.addEventListener("click",
        mainImg8.setAttribute("src", `
          /Indoor Plantation/assets/products img/product8 close 2.jpg`)
    )
}
function changeImg24() {
    quicImg24.addEventListener("click",
        mainImg8.setAttribute("src", `
     /Indoor Plantation/assets/products img/product8.jpg`)
    )
}
